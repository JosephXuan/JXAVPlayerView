...
- (void)setupAllViewController {
     ...
     [self setupOneViewController:[[JXVideoHomeViewController alloc] init] image:[UIImage imageNamed:@"TabBar_home"] selImage:[UIImage imageNamed:@"TabBar_home_sel"] title:@"首页"];
    
    [self setupOneViewController:[[JXVideoPlayViewController alloc] init] image:[UIImage imageNamed:@"TabBar_mine"] selImage:[UIImage imageNamed:@"TabBar_mine_sel"] title:@"个人"];
